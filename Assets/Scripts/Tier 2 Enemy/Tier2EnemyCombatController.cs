...
public class Tier2EnemyCombatController : MonoBehaviour
{
    ...
    private float damagePotential = 15f;
    ...
    void Update()
    {
        ...
        if(health <= 0 && isAlive){
            isAlive = false;
            progressionController.addToPlayerExperiencePoints(20);
            AI.enemyKilled();
        }
        if(isAttacking){
